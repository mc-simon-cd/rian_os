...
pub fn update_tss_stack(stack_top: u64) {
    crate::hal::x86_64::gdt::X86_64Context::set_kernel_stack(::x86_64::VirtAddr::new(stack_top));
}
...
pub unsafe fn switch_context(_old: &mut crate::nexus::sched::task_thread::CpuContext, new: &crate::nexus::sched::task_thread::CpuContext) {
